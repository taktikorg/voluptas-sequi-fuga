...
<p align="center">
  <a href="https://www.npmjs.com/package/@taktikorg/voluptas-sequi-fuga"><img src="https://img.shields.io/npm/dm/@taktikorg/voluptas-sequi-fuga.svg" alt="Downloads"></a>
  <a href="https://www.npmjs.com/package/@taktikorg/voluptas-sequi-fuga"><img src="https://img.shields.io/npm/v/@taktikorg/voluptas-sequi-fuga.svg" alt="Version"></a>
  <a href="https://www.npmjs.com/package/@taktikorg/voluptas-sequi-fuga"><img src="https://img.shields.io/npm/l/@taktikorg/voluptas-sequi-fuga.svg" alt="License"></a>
</p>
...
```bash
npm i --save-dev @taktikorg/voluptas-sequi-fuga
```
...
{   
    "presets": [ "es2015" ],
    "plugins": [["@taktikorg/voluptas-sequi-fuga", {"imports": true}]]
}
```
...
React.Fragment is also compiled to inferno createFragment call to ease project migration to Inferno https://github.com/infernojs/@taktikorg/voluptas-sequi-fuga/issues/56.
...
#### Imports (boolean)
@taktikorg/voluptas-sequi-fuga will automatically import the required methods from inferno library.
...
You can verify `@taktikorg/voluptas-sequi-fuga` is used by looking at the compiled output.
